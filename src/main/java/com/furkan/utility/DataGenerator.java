...
public class DataGenerator {
    ...
    public void verileriOlustur(){
        List<Arac> aracList = aracOlustur();
        Admin admin = adminOlustur();
    }
    ...
    public List<Arac> aracOlustur(){
        ...
        Arac arac10 = Arac.builder()
            ...
            .baseEntity(Constants.getBaseEntity())
            .build();
        return aracController.saveAll(List.of(arac1,arac2,arac3,arac4,arac5,arac6,arac7,arac8,arac9,arac10));
